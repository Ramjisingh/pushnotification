...
public class PushNotifictionController {
  ...
  @PostMapping("/notification/token")
    public ResponseEntity<Response<PushNotificationResponse>> sendTokenNotification(@RequestBody PushNotificationRequest request) {
        ...
        Response<PushNotificationResponse> standardizedResponse = new Response<>(true, "Success", response);
